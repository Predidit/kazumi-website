      ...
      <div class="download-list">
        ...
        >
          <div class="platform-header">
            <span class="platform-icon" v-html="platformIcons[platform.id]"></span>
