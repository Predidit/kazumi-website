...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      // 导航菜单
      {
        text: '<iconify-icon icon="mdi:home" style="color:var(--vp-c-brand-1)" class="i-mr"></iconify-icon>主页',
        link: "/",
      },
      {
        text: '<iconify-icon icon="mdi:file-document" style="color:#4a9eff" class="i-mr"></iconify-icon>文档',
        link: "/docs/intro/what-is-kazumi",
      },
      {
        text: '<iconify-icon icon="mdi:download" style="color:#ff9500" class="i-mr"></iconify-icon>下载',
        link: "/download",
      },
      {
        ...
        items: [
          {
            text: '<iconify-icon icon="mdi:palette" style="color:#e879f9" class="i-mr"></iconify-icon>图标',
            link: "/about/icon",
          },
          {
            text: '<iconify-icon icon="mdi:github" style="color:#8b949e" class="i-mr"></iconify-icon>Issue',
            link: "https://github.com/Predidit/Kazumi/issues",
          },
          {
            text: '<iconify-icon icon="mdi:hand-heart" style="color:#f43f5e" class="i-mr"></iconify-icon>参与贡献',
