...
![sideloadly.png](/docs/assets/how-to-install-in-ios/sideloadly.png)
...
3. 点击左侧的 IPA 图标，选择已下载的 Kazumi IPA 文件，点击 `Start` 按钮开始安装。
    ...
    ![ready.png](/docs/assets/how-to-install-in-ios/ready.png)

4. 首次使用时，需输入 Apple ID 密码。若开启了双重认证，请在弹窗中输入手机收到的 6 位验证码。

5. 等待进度条跑完，当显示 `Done.` 时即表示安装成功。

   ![done.png](/docs/assets/how-to-install-in-ios/done.png)
...
3.  登录 Apple Account。
    ![login.png](/docs/assets/how-to-install-in-ios/login.png)
4.  安装 LiveContainer+SideStore
    ![install.png](/docs/assets/how-to-install-in-ios/install.png)
5. 信任 LiveContainer。
    1. 打开 iOS `设置` -> `通用`。
...
4.  点击左上方 SideStore 图标（首次会闪退）。
    ![LiveContainer.png](/docs/assets/how-to-install-in-ios/LiveContainer.png)
5.  打开 SideStore，切换到 **My Apps** 标签页。
6.  点击 `Refresh All`，输入你的 Apple Account 账户及密码。
    ![SideStore.png](/docs/assets/how-to-install-in-ios/SideStore.png)
7.  退出 SideStore，再次进入 LiveContainer，切换到 **设置** 标签页，点击 `从 SideStore 导入证书`。
    ![setting.png](/docs/assets/how-to-install-in-ios/setting.png)
